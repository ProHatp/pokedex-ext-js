...
Projeto criado para fins didáticos para estudar o EXTSJ, uma framework da sencha esse projeto carrega inicialmente 100 pokemons, com button para carregar mais ate carregar todos, vem os elementos e altura do pokemon abrindo um modal com os dados de força, defesa especial-attack entre outros.

# OQUE FOI USADO?

> FRAMEWORK EXTJS 3.4 [LINK OFICIAL](https://www.sencha.com/)
> FRAMEWORK CHARTJS [LINK OFICIAL](https://www.chartjs.org/)
> API DO POKEMON [LINK OFICIAL](https://pokeapi.co/)

# EXEMPLO DO PROJETO

![enter image description here](https://github.com/ProHatp/pokedex-ext-js/blob/main/demo.gif)
